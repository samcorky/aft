...
class TestTimeFormatSettings:
    ...
    def test_get_time_format_default(self, api_client, authenticated_session):
        """Test that time_format has a default value of '24'."""
        response = authenticated_session.get(f'{api_client}/api/settings/time_format')
    ...
    def test_set_time_format_to_12_hour(self, api_client, authenticated_session):
        ...
        # Verify it persists
        get_response = authenticated_session.get(f'{api_client}/api/settings/time_format')
        assert get_response.json()['value'] == '12'
    
    def test_set_time_format_to_24_hour(self, api_client, authenticated_session):
    ...
    def test_invalid_time_format_value(self, api_client, authenticated_session):
    ...
    def test_time_format_in_schema(self, api_client, authenticated_session):
    ...
    def test_time_format_toggle(self, api_client, authenticated_session):
